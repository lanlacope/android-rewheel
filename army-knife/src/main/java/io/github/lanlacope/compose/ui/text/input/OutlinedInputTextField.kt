package io.github.lanlacope.compose.ui.text.input
...
fun OutlinedInputTextField(
    ...
    colors: TextFieldColors = InputTextFieldDefaults.colors(),
) {
    ...
    OutlinedTextField(
        ...
        colors = colors.labelFocuseObserve(text, isFocused),
        shape = shape,
    )
}
...
fun OutlinedInputTextField(
    ...
    OutlinedTextField(
        ...
        minLines = minLines,
        interactionSource = interactionSource,
        colors = colors.labelFocuseObserve(value.text, isFocused),
        shape = shape,
    )
}