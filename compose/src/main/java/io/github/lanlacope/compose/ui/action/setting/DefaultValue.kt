...
internal fun SettingTextStyleDefault(): TextStyle = TextStyle(fontSize = 18.sp)

internal fun SettingSummaryTextStyleDefault(): TextStyle = TextStyle(color = Color.Gray)
